<?php get_header(); ?>
<section id="blog">
	<div id="blog-title"><h1><?php _e('Search results:', 'golev'); ?></h1></div>
	<div id="content" class="row gutters">
		<div id="posts" class="column-11" style="background-color:#fff;">
			...
			<div class="text-wrapp">
				<p class="search-error"><?php _e("Sorry, but your search hasn't returned any result. Please try a different keyword or browse using categories & tags", 'golev'); ?></p>
			</div>
			<?php endif; ?>
		</div>
		<?php get_sidebar(); ?>
